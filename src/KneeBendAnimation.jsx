...
export default function App() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // small tail sway
      const tailAngle = Math.sin(t * 1.2) * 6;
        ...
        <div style={scaleWrapper}>
          <div style={scaleContainer}>
            ...
            <div ref={catRef} style={cat}>
             ...
             {/* arms (stationary & fixed) */}
                <div style={upperArmLeft}>
                <div style={lowerArmLeft}>
                    <div style={paw}/>
                </div>
                </div>

                <div style={upperArmRight}>
...
const torso = {
  ...
  width: 95,
  height: 140,
  background: "linear-gradient(145deg,#b9682c,#6b3a14)",
...
const upperArmLeft = {
  ...
  width: 20,
  height: 75,
  background: "linear-gradient(#b9682c,#6b3a14)",
  borderRadius: 20,
...
const upperLegLeft = {
  ...
  width: 24,
  height: 70,
  background: "linear-gradient(#6b3a14,#3e210d)",
  borderRadius: 20
};
...
const tailStyle = {
  ...
  width: 22,
  height: 135,
  background: "linear-gradient(180deg,#c07a3a,#5a2f10)",
  borderRadius: 18,
  transformOrigin: "bottom center"
};
